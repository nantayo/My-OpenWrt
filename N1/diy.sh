...
# Update packages
cp -fr package/amlogic/luci-app-amlogic package/mosdns/luci-app-mosdns package/my-pkg/luci-app-passwall feeds/luci/applications/
...
# Clean packages
rm -rf package/amlogic package/my-pkg package/mosdns